...
The full authorship guide has the field-fill cheat sheet in PM/PO voice, a worked example per record type, and guidance on how your Context records feed into architect Decisions via `constrained_by`:

[PM/PO Authorship Guide](../../model/by-persona/pm-authorship.md)
