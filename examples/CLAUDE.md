...
The Copilot-format equivalent of this file is [`.github/instructions/examples.instructions.md`](../.github/instructions/examples.instructions.md) (with `applyTo: 'examples/**'`). Keep both in sync when changing this guidance.
