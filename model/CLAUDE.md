...
The Copilot-format equivalent of this file is [`.github/instructions/model.instructions.md`](../.github/instructions/model.instructions.md) (with `applyTo: 'model/**'`). Keep both in sync when changing this guidance.
