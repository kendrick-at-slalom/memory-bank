---
description: Interactively scaffold a memory bank into the current repo or a separate bank repo.
---

<!-- Kept in sync with .github/prompts/scaffold-memory-bank.prompt.md and the body inside the four-backtick fence in SCAFFOLD.md (repo root). Change once, replicate to all three. -->
